...
const tournamentsSchema = new mongoose.Schema({
    ...
    max_total_participant: {type: Number, required: true, max: 100, default: 100},
    ...
    first_winner: {type: String, ref: "Team", default:""},
    second_winner: {type: String, ref: "Team", default:""},
    third_winner: {type: String, ref: "Team", default:""},
